...
public class BloodBankDetails extends JFrame implements ActionListener {
    ...
    JTextField t2;
    JComboBox c2;
    String x[] = {"ID", "Name", "Address", "Contact", "Email", "Blood Group", "Quantity"};
    String y[][] = new String[1000][13];
    String p[][] = new String[1000][13];
    int i = 0, j = 0;

    BloodBankDetails() {
        super("Blood Bank Details");
        setSize(1610, 905);
        setLayout(null);
        
        l = new JLabel("BLOOD BANK INFORMATION TABLE");
        ...
        try {
            ...
            String s1 = "SELECT blood_bank.id,blood_bank.name,blood_bank.address,blood_bank.contact,blood_bank.email,blood_bag.blood_group,blood_bag.quantity FROM blood_bank INNER JOIN blood_bag ON blood_bank.id = blood_bag.id ; ";
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == b1) {
            try {
                ...
                String q = "SELECT blood_bank.id,blood_bank.name,blood_bank.address,blood_bank.contact,blood_bank.email,blood_bag.blood_group,blood_bag.quantity FROM blood_bank INNER JOIN blood_bag ON blood_bank.id = blood_bag.id and blood_group = '" + b + "' ";
