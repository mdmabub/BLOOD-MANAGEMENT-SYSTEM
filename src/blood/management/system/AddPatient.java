...
class AddPatient implements ActionListener{
    ...
    public AddPatient(){
        ...
        id9 = new JLabel("REGISTER NEW PATIENT DETAILS");
        id9.setBounds(480,100,800,50);
        ...
        t1 = new JTextField();
        t1.setBounds(720,200,250,30);
        id10.add(t1);
        
        id2 = new JLabel("Blood Group :");
        id2.setBounds(550,250,200,30);
        ...
        id5.setBounds(550,400,150,30);
        id5.setFont(new Font("serif",Font.BOLD,25));
        id10.add(id5);
        
        t5 = new JTextField();
        t5.setBounds(720,400,250,30);
        id10.add(t5);
        
        id6 = new JLabel("Disease :");
        id6.setBounds(550,450,150,30);
        id6.setFont(new Font("serif",Font.BOLD,25));
        id10.add(id6);
        
        t6 = new JTextField();
        t6.setBounds(720,450,250,30);
        id10.add(t6);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b1){
          try{
              ...
              String q = "insert into patient (`name`, `blood_group`, `contact`, `email`, `location`, `disease`) values('"+a+"','"+b+"','"+c+"','"+d+"','"+e+"','"+ff+"')";
